    ...
    $("#table-sellers").tablesorter({
        ...
        widgetOptions: {
            ...
            filter_functions : {
                ...
                5 : {
                  "Oui" : function(e, n, f, i, $r, c, data) { console.log(e);console.log(n);console.log(f);console.log(i);console.log(c);console.log(data); return /glyphicon-ok/.test(e); },
                  "Non" : function(e, n, f, i, $r, c, data) { console.log(e);return /glyphicon-remove/.test(e); },
                }
            },
