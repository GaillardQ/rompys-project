...
use Frontend\FrontOfficeBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FrontendFrontOfficeBundle:News')->findAll();
     ...
     * @Method("POST")
     * @Template("FrontendFrontOfficeBundle:News:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FrontendFrontOfficeBundle:News')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FrontendFrontOfficeBundle:News:edit.html.twig")
     */
